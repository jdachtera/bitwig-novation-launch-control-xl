...
function TrackSelectorButtons(midiMessages, trackBank) {
	...
	this.trackBank.addCanScrollTracksUpObserver(this._previous.set.bind(this._previous, 'value'));
	this.trackBank.addCanScrollTracksDownObserver(this._next.set.bind(this._next, 'value'));
}
