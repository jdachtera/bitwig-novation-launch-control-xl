...
function SceneSelectorButtons(midiMessages, trackBank, numberOfTracks)
{
    ...
    this.trackBank.addCanScrollScenesUpObserver(this._previous.set.bind(this._previous, 'value'));
    this.trackBank.addCanScrollScenesDownObserver(this._next.set.bind(this._next, 'value'));
